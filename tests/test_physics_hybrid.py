...
def test_hybrid_always_fast():
    ...
    assert engine.should_limit_fill(limit_price=100, market_high=101, market_low=99, volume=1000, quantity=10) is True
...
def test_hybrid_always_realistic():
    ...
    market_data = {'Open': 100, 'High': 101, 'Low': 99, 'Close': 100, 'Volume': 1000}
    price_hybrid = engine.calculate_execution_price(base_price, qty, instr, market_data)
    price_real = realistic.calculate_execution_price(base_price, qty, instr, market_data)
    ...
    assert engine.should_limit_fill(limit_price=100, market_high=101, market_low=99, volume=1000, quantity=1) is True
